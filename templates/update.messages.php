<center>
    <FORM action="messages.php" method=POST>
        <table width="750" cellpadding="0" cellspacing="5" bgcolor="#3366cc" style="border: 1px solid #000000;">
            <tr>
                <td>
                    <p class="white_header">-- Change a Message --</p>
                </td>
            </tr>
        </table>
        <table border="0" cellpadding="0" cellspacing="5" width="750" bgcolor="#CCCCCC"
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input name="subj" size=98 maxlength=250 class="fields" value="<?php echo $DB_MsgSub; ?>">
                </td>
            </tr>
            <tr>
                <td colspan="2"><br/></td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <textarea name="bodytext" rows=10 cols=96
                              class="text_area"><?php echo $DB_MsgBodyText; ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2"><br/></td>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <textarea name="bodyhtml" rows=14 cols=96
                              class="html_area"><?php echo $DB_MsgBodyHTML; ?></textarea>
                </td>
            </tr>
            <tr>
                <td colspan="2"><br/></td>
                ...
                <td colspan="2">
                    <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                            ...
                            <td width="165"><input name="months" size=13 maxlength=20 class="fields"
                                                   value="<?php echo $DB_MsgMonths; ?>"></td>
                            <td width="80"><font color="#660000" size="4">Weeks:</font></td>
                            <td width="165"><input name="weeks" size=13 maxlength=20 class="fields"
                                                   value="<?php echo $T_weeks; ?>"></td>
                            <td width="80">&nbsp;</td>
                            <td width="165">&nbsp;</td>
                        </tr>
                        <tr>
                            <td width="80"><font color="#660066" size="4">Days:</font></td>
                            <td width="165"><input name="days" size=13 maxlength=20 class="fields"
                                                   value="<?php echo $T_days; ?>"></td>
                            <td width="80"><font color="#660066" size="4">Hours:</font></td>
                            <td width="165"><input name="hours" size=13 maxlength=20 class="fields"
                                                   value="<?php echo $T_hours; ?>"></td>
                            <td width="80"><font color="#000066" size="4">Minutes:</font></td>
                            <td width="165"><input name="min" size=13 maxlength=20 class="fields"
                                                   value="<?php echo $T_minutes; ?>"></td>
                        </tr>
                        <tr>
                            <td colspan="6"><br/>
